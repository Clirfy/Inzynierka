...
namespace TransportServicesApp.Migrations
{
    ...
    [Migration("20200129171117_adjust")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportServicesApp.Models.CargoOffer", b =>
                {
                    b.HasBaseType("TransportServicesApp.Models.Offer");

                    b.Property<string>("MaxSize");

                    b.Property<string>("MaxWeight");

                    b.HasDiscriminator().HasValue("CargoOffer");
                });

            modelBuilder.Entity("TransportServicesApp.Models.PassangerOffer", b =>
                {
                    b.HasBaseType("TransportServicesApp.Models.Offer");
                    ...
                    b.HasDiscriminator().HasValue("PassangerOffer");
                });

            modelBuilder.Entity("TransportServicesApp.Models.CargoRequest", b =>
                {
                    b.HasBaseType("TransportServicesApp.Models.Request");
                    ...
                    b.HasDiscriminator().HasValue("CargoRequest");
                });

            modelBuilder.Entity("TransportServicesApp.Models.PassengerRequest", b =>
                {
                    b.HasBaseType("TransportServicesApp.Models.Request");

                    b.Property<bool>("AdditionalBaggage")
                        .HasColumnName("PassengerRequest_AdditionalBaggage");

                    b.Property<string>("PassengerAmmount");

                    b.HasDiscriminator().HasValue("PassengerRequest");
                });
